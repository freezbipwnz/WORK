...
function RushBadge() {
  ...
  return (
    <div
      className="anim-pop-in flex min-h-[44px] items-center gap-1.5 rounded-full px-3 py-1.5 font-display text-xs font-bold text-white shadow-sticker"
...
const hudBtn =
  'flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl px-1 text-lg transition-transform active:scale-90 md:text-xl xl:text-2xl'
