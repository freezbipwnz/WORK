  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <div className="h-1.5 w-16 overflow-hidden rounded-full bg-wall shadow-card-inset sm:h-2 sm:w-32 xl:w-40">
          <motion.div
        ...
        <span className="tnum text-xs font-medium leading-none text-cocoa-soft">
          {xp} / {target} XP
        </span>
      </div>
    </div>
